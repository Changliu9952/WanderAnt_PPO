...
class dppo_workers:
    ...
    def train_network(self, traffic_signal, critic_counter, actor_counter, shared_critic_model, shared_actor_model, \
        ...
        while True:
            ...
            critic_loss, actor_loss = self.update_network(brain_memory, critic_shared_grad_buffer,
    ...
    # calculate the gradients...
    def calculate_the_gradients(self, state_batch_tensor, actions_batch, returns, advantages, old_action_prob,
                                critic_shared_grad_buffer, \
                                actor_shared_grad_buffer, shared_critic_model, shared_actor_model, critic_counter,
                                actor_counter, traffic_signal):
